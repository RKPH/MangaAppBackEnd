...
namespace MangaApp.Migrations
{
    ...
    [Migration("20240720123307_Fix db")]
    partial class Fixdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaApp.Model.Domain.CommentLike", b =>
                {
                    ...
                    b.HasKey("CommentLikeId", "CommentId", "UserId");
            ...
            modelBuilder.Entity("MangaApp.Model.Domain.Comments", b =>
                {
                    b.Property<Guid>("CommentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MangaApp.Model.Domain.Gacha", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MangaApp.Model.Domain.CommentLike", b =>
                {
                    b.HasOne("MangaApp.Model.Domain.Comments", "Comment")
                        .WithMany("CommentLikes")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangaApp.Model.Domain.Comments", "Comments")
                        .WithMany()
